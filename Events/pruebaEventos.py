...
eventSender.addEvent(EyeTrackingEvent(timestamp=time.time(), leftPupilX=100, leftPupilY=200,rightPupilX=600,rightPupilY=700))
eventSender.addEvent(EyeTrackingEvent(timestamp=time.time(), leftPupilX=100, leftPupilY=0,rightPupilX=900,rightPupilY=200))
